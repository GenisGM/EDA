...
public class ABB<E extends Comparable<E>> {
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        NodoABB<E> nodo = new NodoABB<E>(v[mediana]);
        nodo.izq = construirEquilibrado(v, ini, mediana-1);
        nodo.der = construirEquilibrado(v, mediana+1 , fin);
        return nodo;
    }
    ...
    public void reconstruirEquilibrado() {        
        // COMPLETAR
        E array[] = toArrayInOrden();
        raiz = construirEquilibrado(array,0,array.length-1);
    }
